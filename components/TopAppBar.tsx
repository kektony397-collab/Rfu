...
const TopAppBar: React.FC<TopAppBarProps> = ({ theme, toggleTheme, onExport }) => {
    const getThemeIcon = () => {
        switch (theme) {
            case 'dark': return 'dark_mode';
            case 'system': return 'brightness_auto';
            default: return 'palette'; // Icon for all light themes
        }
    };
    
    return (
        <header className="fixed top-0 left-0 right-0 h-16 bg-surface z-10 shadow-sm transition-colors duration-300">
